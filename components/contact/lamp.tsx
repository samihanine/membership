  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-slate-200 to-slate-400 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-6xl"
      >
        Votre voyage,
        <br /> notre dévouement.
      </motion.h1>
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-full flex-col items-center justify-center overflow-hidden bg-black w-full z-0",
        className,
      )}
    >
