...
import HomeStepsImage from "../../public/images/home-steps.jpg";
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="text-3xl md:text-4xl font-medium font-cabinet-grotesk">
              Découvrez le confort et le luxe d&apos;un voyage éco-responsable à
              Lyon.{" "}
            </h2>
          </div>
          ...
          <div className="relative pb-12">
            {/* Line */}
            <div
              className="hidden lg:block absolute top-4 left-32 right-32 mt-px h-0.5 bg-border -z-10"
              aria-hidden="true"
            />
            ...
            <div className="max-w-sm mx-auto grid gap-12 sm:grid-cols-2 sm:max-w-3xl lg:grid-cols-4 lg:max-w-none items-start">
              ...
              <div className="text-center">
                <div className="w-9 h-9 bg-foreground dark:bg-background border-2 border-border text-white text-[15px] font-bold rounded-full inline-flex items-center justify-center mb-3">
                  1
                </div>
                ...
                <div className="text-gray-500">
                  Estimation instantanée, tarification transparente.
                </div>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-cabinet-grotesk font-bold text-lg">
                  Réservation de ma course
                </h3>
                <div className="text-gray-500">
                  Réservez facilement, voyagez l&apos;esprit tranquille.
                </div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-gray-500">
                  Confirmation instantanée, zéro attente.
                </div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-gray-500">
                  Confort et ponctualité à chaque voyage.
                </div>
              </div>
            </div>
          </div>
